...
type Scheduler struct {
	...
	Name    string             `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Init    float64            `protobuf:"fixed64,2,opt,name=init,proto3" json:"init,omitempty"`
...
func (x *Scheduler) GetInit() float64 {
	if x != nil {
		return x.Init
	}
	return 0
...
func (x *Scheduler) GetCurrent() float64 {
	if x != nil {
		return x.Current
	}
	return 0
...
func (x *Scheduler) GetParams() map[string]float64 {
	if x != nil {
		return x.Params
	}
	return nil
...
var file_model_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x6c, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01,
	0x52, 0x02, 0x6c, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x5f, 0x64,
	0x65, 0x63, 0x61, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b, 0x77, 0x65, 0x69, 0x67,
	...
	0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x04, 0x69, 0x6e, 0x69, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63,
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x07, 0x63, 0x75,
